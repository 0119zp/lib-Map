...
public class GPSPointUtil {
     ...
     */
    public static Gps gcj02_To_Bd09(double ggLat, double ggLon) {
        double x = ggLon;
        double y = ggLat;
     ...
     */
    public static Gps bd09_To_Gcj02(double bdLat, double bdLon) {
     ...
     * (BD-09)-->84
     */
    public static Gps bd09_To_Gps84(double bdLat, double bdLon) {

        Gps gcj02 = GPSPointUtil.bd09_To_Gcj02(bdLat, bdLon);
        Gps map84 = GPSPointUtil.gcj_To_Gps84(gcj02.getWgLat(),
                gcj02.getWgLon());
        return map84;
